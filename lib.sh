...
IS_REF=$(grep -q '"magento/module-catalog-sample-data"' "${SCRIPTS_DIR}/../../../composer.json" && ! grep -q '"magentoese/module-demo-admin-configurations"' "${SCRIPTS_DIR}/../../../composer.json" && echo "true" || echo "false")
